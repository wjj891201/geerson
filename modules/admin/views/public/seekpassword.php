...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="login-layout">
                                ...
                                <fieldset>
                                    <label class="block clearfix">
                                        <span class="block input-icon input-icon-right">
                                            <?php echo $form->field($model, 'user')->textInput(['class' => 'form-control', 'placeholder' => '登录名']); ?>
                                            <i class="icon-user"></i>
                                        </span>
                                    </label>
                                    ...
                                    <label class="block clearfix">
                                        <span class="block input-icon input-icon-right">
                                            <?php echo $form->field($model, 'email')->textInput(['class' => 'form-control', 'placeholder' => '管理员邮箱']); ?>
                                            <i class="icon-mail-forward"></i>
                                        </span>
                                    </label>

                                    <div class="clearfix">
                                        <?php echo Html::submitButton('提交', ["class" => "width-35 pull-right btn btn-sm btn-primary", 'id' => "login_btn"]); ?>
                                    </div>
        ...
        <div class="loginbm">版权所有  2016  <a href="">南京腾易</a> </div><strong></strong>
    </body>
</html>