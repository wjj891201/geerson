    ...
    <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        ...
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
            ...
            <tr>
                ...
                <td colspan="3">
                    <?php $m_info = Model::getOne(['id' => $model->mid]); ?>
                    <?= $m_info['modelname'] ?>
                </td>
            </tr>
            <?php if ($model->upid): ?>
                <tr>
                    ...
                    <td colspan="3">
                        <?= $form->field($model, 'upid')->dropDownList($list)->label(false); ?>
                    </td>
                </tr>
            <?php endif; ?>
            <tr>
            ...
            <tr>
                ...
                <td colspan="3">
                    <?= $form->field($model, 'typename_en')->textInput(['class' => 'inpMain', 'size' => 40])->label(false); ?>
                </td>
            </tr>
            ...
            <tr><th colspan="4" style="background: #92D6E3; text-align: left; ">显示样式及其它属性</th></tr>
                ...
                <tr>
                    ...
                    <td colspan="3"><?= $form->field($model, 'styleid')->dropDownList($styleid_arr, ['style' => 'width:200px;'])->label(false); ?></td>
                </tr>
                <tr>
            ...
            <?php else: ?>
                <?= $form->field($model, 'styleid')->textInput()->hiddenInput()->label(false); ?>
            <?php endif; ?>
            <?php if (in_array($model->styleid, [1, 2, 4])): ?>
                <tr>
